                ...
                <form noValidate onSubmit={this.submitFB}>
                    <div
                        ...
                        <Typography
                            ...
                            {this.props.categories[this.state.cT]}
                        </Typography>
                    ...
                    <div
                        ...
                        <TextField id={"category"} label={"想说啥..."} multiline rowsMax="10" fullWidth value={this.state.text} onChange={e=>this.setState({text:e.target.value})}/>
                    </div>
                    <div
                        style={{
                        display: 'flex',
